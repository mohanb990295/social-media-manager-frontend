...
export default function Editor() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      // Simulate API call
      setTimeout(() => {
        const mockContent = `Here's AI-generated content for ${selectedPlatform} about "${topic}". This is placeholder content that would be generated by Claude AI.`;
        setGeneratedContent(mockContent);
        setIsGenerating(false);
      }, 2000);
    } catch (err) {
      setError("Error generating content. Make sure your API key is set.");
      console.error(err);
      setIsGenerating(false);
    }
  };
